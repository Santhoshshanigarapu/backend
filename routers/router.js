...
const TopSellingItem = require('../controllers/topSelling');
const TotalPurchases = require('../controllers/totalPurchases');
//const TotalOrders = require('../controllers/totalOrders');
...
router.get('/topSellingItems', TopSellingItem.getTopSellingItems);
router.get('/totalPurchases',TotalPurchases.getTotalPurchasesAndQuantitySold );
//router.get('/totalOrders',TotalOrders.getTotalOrdersAndQuantitySold);
